...
export function setupSecurityMiddleware(app: Express) {
  ...
  console.log(`[Security] CORS origin: ${isProduction ? frontendUrl : 'all origins (development)'}`);
  console.log(`[Security] HTTPS enforcement: ${isProduction ? 'enabled' : 'disabled (development)'}`);
}
